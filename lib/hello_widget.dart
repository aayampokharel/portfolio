      ...
      child: LayoutBuilder(builder: (context, constraints) {
        return Column(
          ...
          children: [
            Row(
              ...
              children: [
                constraints.maxWidth > 880
                    ...
                    : TextController.mediumWhite("Hello, ").returnText(),
                // Use Expanded to fill the remaining space and center the second text
                Flexible(
                  child: constraints.maxWidth > 880
                      ? TextController.LargeWhite("I am Aayam Pokharel,")
                          .returnText(
                          fontFamily: "Cursive",
                        )
                      : TextController.mediumWhite(
                          "I am Aayam Pokharel,",
                        ).returnText(
                          fontFamily: "Cursive",
                        ),
            ...
            constraints.maxWidth > 880
                ? TextController.mediumWhite("A Full Stack Developer ,")
                    .returnText()
                : TextController.custom("A Full Stack Developer ,",
                        fontSize: 18, color: Colors.white)
                    .returnText(),
            const SizedBox(
              height: 10,
            ),
            ContainerController.button(buttonColor: const Color(0xff36B2B8))
                .returnButton(
